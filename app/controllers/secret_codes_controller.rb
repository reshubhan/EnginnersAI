class SecretCodesController < ApplicationController
  ...
  def create
    number_of_secret_code = params[:secret_code][:code].to_i
    number_of_secret_code.times do 
    ...
    respond_to do |format|
      format.html { redirect_to secret_codes_url, notice: 'Secret codes were successfully created.' }
    end
  end
